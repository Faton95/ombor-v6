...
const PageSupplier = lazy(() => import('src/pages/dashboard/supplier'));
const PageStatus = lazy(() => import('src/pages/dashboard/status'));
const PageDepartment = lazy(() => import('src/pages/dashboard/department'));
...
export const dashboardRoutes = [
  {
    ...
    children: [
      ...
      { path: 'department', element: <PageDepartment /> },
